...
<template>
  ...
  <!-- <Container>
    <div class="flex flex-col justify-center">
      ...
      <div class="mt-10 flex flex-wrap justify-center gap-5 md:justify-around">
        <div class="pt-2 text-gray-400 dark:text-gray-400" v-html="AmazonLogo()" />
        <div class="text-gray-400 dark:text-gray-400" v-html="VerizonLogo()" />
        <div class="text-gray-400 dark:text-gray-400" v-html="MicrosoftLogo()" />
        <div class="pt-1 text-gray-400 dark:text-gray-400" v-html="NetflixLogo()" />
