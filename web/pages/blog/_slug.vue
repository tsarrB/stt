    ...
    <Container>
      <Content>
        <div class="mx-auto max-w-screen-xl flex justify-between px-4">
          <article class="format format-sm sm:format-base lg:format-lg format-blue dark:format-invert mx-auto max-w-2xl w-full">
            ...
            <p>
              ...
              >comparison table</a> to better understand
...
&lt;/dl&gt;
    ...
    <aside aria-label="Related articles" class="bg-gray-50 py-8 dark:bg-gray-800 lg:py-24">
      <div class="mx-auto max-w-screen-xl px-4">
        ...
        <div class="grid gap-12 lg:grid-cols-4 sm:grid-cols-2">
          <article class="max-w-xs">
            ...
            <a href="#" class="inline-flex items-center font-medium text-blue-600 underline underline-offset-4 dark:text-blue-500 hover:no-underline">
              Read in 2 minutes
            </a>
          </article>
          <article class="max-w-xs">
    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
        <div class="mx-auto max-w-screen-md sm:text-center">
          ...
          <form action="#">
            <div class="mx-auto mb-3 max-w-screen-sm items-center sm:flex space-y-4 sm:space-y-0">
              <div class="relative w-full">
                <label for="email" class="mb-2 hidden text-sm font-medium text-gray-900 dark:text-gray-300">Email address</label>
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                  <svg class="h-5 w-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" /><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" /></svg>
                </div>
                <input id="email" class="block w-full border border-gray-300 rounded-lg bg-white p-3 pl-10 text-sm text-gray-900 dark:border-gray-600 focus:border-blue-500 sm:rounded-none sm:rounded-l-lg dark:bg-gray-700 dark:text-white focus:ring-blue-500 dark:focus:border-blue-500 dark:focus:ring-blue-500 dark:placeholder-gray-400" placeholder="Enter your email" type="email" required>
              </div>
              <div>
                <button type="submit" class="w-full cursor-pointer border border-blue-600 rounded-lg bg-blue-700 px-5 py-3 text-center text-sm font-medium text-white sm:rounded-none sm:rounded-r-lg dark:bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Subscribe
                </button>
              </div>
            </div>
            <div class="newsletter-form-footer mx-auto max-w-screen-sm text-left text-sm text-gray-500 dark:text-gray-300">
              We care about the protection of your data. <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Read our Privacy Policy</a>.
            </div>
          </form>
        </div>
      </div>
